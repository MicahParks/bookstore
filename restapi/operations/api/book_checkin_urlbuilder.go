...
func (o *BookCheckinURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on BookCheckinURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on BookCheckinURL")
	}
