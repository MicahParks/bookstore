...
func (o *BookHistoryURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on BookHistoryURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on BookHistoryURL")
	}
